                ...
                <div className="container-fluid">
                    ...
                    <form onSubmit={this.submitHandler}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="text" className="form-control" id="bookName" name="bookName" aria-describedby="bookHelp" placeholder="Enter book title" onChange={this.changeHandler} size="20"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <input type="number" className="form-control" id="price" name="price" aria-describedby="priceHelp" min="0" placeholder="Enter book price" onChange={this.changeHandler}/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <textarea className="form-control" rows="3" value={this.state.bookDescription} onChange={this.changeHandler} name='bookDescription' placeholder="Write a description for the product"></textarea>
                            </div>
                        </div>
                        {/* image */}
                        <div class="form-group row">
