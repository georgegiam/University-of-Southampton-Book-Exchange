    ...
    buyHandler() {
        ...
        var user = firebase.auth().currentUser
            if (user) {
                ...
                Firebase.addAppointment(this.state.book.ID, this.state.book.isAvailable, this.state.book.bookName, this.state.book.bookDescription, this.state.book.bookPrice, user.uid, user.email ,this.state.book.sellerID, user.displayName);
